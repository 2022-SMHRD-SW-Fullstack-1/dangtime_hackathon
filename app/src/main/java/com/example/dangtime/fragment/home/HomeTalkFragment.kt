...
class HomeTalkFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_talk, container, false)
        val rvHomeTalk = view.findViewById<RecyclerView>(R.id.rvHomeTalk)
        ...
        rvHomeTalk.adapter = adapter

        rvHomeTalk.layoutManager = GridLayoutManager(requireContext(), 1)
